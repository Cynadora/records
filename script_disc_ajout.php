...
// Gestion du téléchargement de l'image (upload)/Il commence par initialiser la variable $picture à null.
$picture = null;
...
try {
    ...
    $requete = $db->prepare("UPDATE disc SET disc_title = title, disc_year = year, disc_picture = picture, disc_label = label, disc_genre = genre, disc_price = price, artist_id = id");
